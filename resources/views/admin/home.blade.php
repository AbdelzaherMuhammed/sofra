...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{$resturants->count()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-blue-gradient"><i class="fa fa-sitemap"></i></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-red-gradient"><i class="fa fa-gift"></i></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">الاحياء</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-gray"><i class="fa fa-shopping-cart "></i></span>
                    <div class="info-box-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-maroon-gradient"><i class="fa fa-bars"></i></span>
                    <div class="info-box-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-light-blue-gradient"><i class="fa fa-credit-card "></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">طرق الدفع</span>
                        <span class="info-box-number">{{$payment_methods->count()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            </div>
